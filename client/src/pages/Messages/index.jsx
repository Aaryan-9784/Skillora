...
const Messages = () => {
  ...
  const {
    ...
    deleteConversation, replyingTo, setReplyTo, clearReplyTo, toggleReaction, openDirectChat
  } = useChatStore();
  ...
  return (
    <div className="h-full flex-1 flex flex-col min-h-0 relative overflow-hidden"
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between mt-0.5">
                        ...
                        <div className="flex items-center gap-1.5 shrink-0">
                          {contact.badge && (
                            <span className="text-[9px] font-extrabold bg-indigo-500 text-white px-1.5 py-0.5 rounded-md">
                              {contact.badge}
                            </span>
                          )}
            ...
            <>
                          ...
                          <button
                            onClick={() => {
                              ...
                              if (activeConversation?._id) {
                                setDeleteConvModal({
                                  conversationId: activeConversation._id,
                                  name: partner?.name || "Client Contact",
                                });
                              }
                            }}
              ...
              <div className="p-3 bg-[#111b21] border-t border-slate-800 shrink-0">
                ...
                {showVoiceRecorder ? (
                  ...
                  <input
                    type="text"
                    placeholder={stagedAttachment ? "Add a message caption (optional)..." : "Write a message to your project client..."}
                    value={inputText}
      ...
      {/* Delete Connection / Conversation Confirmation Modal */}
      <AnimatePresence>
        {deleteConvModal && (
          <motion.div
            initial={{ opacity: 0 }}
