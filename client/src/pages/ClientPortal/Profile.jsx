...
import {
  ...
  Calendar, Check, Smartphone, QrCode, Copy, Download,
} from "lucide-react";
      ...
      <div className="relative p-6 lg:p-8 max-w-[1400px] mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            <GCard delay={0.45} className="p-6">
              ...
              <p className="text-xs leading-relaxed text-slate-300 my-4">
                Require a 6-digit passcode from your authenticator app each time you sign in to protect your client account.
              </p>
