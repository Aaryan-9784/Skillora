...
const AI_MODELS = [
  { id: "gemini-2.5-flash", name: "Gemini 2.5 Flash", desc: "Fastest & most accurate AI studio model (Active Free Key)", icon: Zap, color: "#635BFF", tag: "Recommended Free" },
  { id: "skillora-pro", name: "Skillora AI Pro", desc: "Ultimate flagship model with maximum speed & reasoning", icon: Sparkles, color: "#A855F7", tag: "Pro Flagship" },
  { id: "gpt-4o", name: "GPT-4o", desc: "Multimodal logic, complex coding & reasoning", icon: Brain, color: "#10A37F", tag: "OpenAI" },
        ...
        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}
          ...
          <div>
            ...
            <p className="text-xs lg:text-sm mt-1 font-medium" style={{ color: "rgba(148,163,184,0.7)" }}>
              Smart AI workspace studio powered by Google Gemini Pro & OpenAI models
            </p>
          </div>
          ...
          <header className="h-14 px-4 bg-[#0E1424]/90 border-b border-slate-800/80 flex items-center justify-between shrink-0 z-30 backdrop-blur-xl">
                    ...
                    >
                      ...
                      {AI_MODELS.map((model) => (
                        <button
                          ...
                          className={`w-full p-2.5 rounded-xl flex items-start gap-3 transition-all text-left cursor-pointer ${selectedModel.id === model.id
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-full text-xs font-semibold flex items-center gap-1.5 transition-all cursor-pointer ${isTemporaryChat
          ...
          <div className="flex-1 flex min-h-0 overflow-hidden relative">
                  ...
                  <div className="flex-1 overflow-y-auto p-2 space-y-4 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
                    ...
                    <div className="space-y-1">
                      ...
                      <button
                        ...
                        className={`w-full p-2.5 rounded-xl flex items-center gap-2.5 text-xs font-semibold text-left transition-all cursor-pointer ${activeSessionId === "current"
                          ? "bg-indigo-600/20 border border-indigo-500/40 text-white shadow-md shadow-indigo-500/10"
                          ...
                          {items.map((sess) => {
                            ...
                            return (
                              <div
                                ...
                                className={`w-full p-2.5 rounded-xl flex items-center justify-between text-xs font-medium transition-all cursor-pointer group ${isSel
            ...
            <main className="flex-1 flex flex-col min-w-0 bg-[#090D16] relative overflow-hidden">
              ...
              <div className="flex-1 overflow-y-auto px-4 py-6 lg:px-8 space-y-6 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
                ...
                {isEmptyChat ? (
                  <div className="h-full max-w-3xl mx-auto flex flex-col items-center justify-center text-center my-auto py-8">

                    {/* ── Premium Animated Hero Greeting Section ── */}
                    <motion.div
                      initial={{ opacity: 0, y: 20 }}
                      animate={{ opacity: 1, y: 0 }}
                      transition={{ duration: 0.7, ease: [0.16, 1, 0.3, 1] }}
                      className="flex flex-col items-center space-y-5 mb-8"
                    >
                      {/* Animated Orb with Layered Pulse Rings */}
                      <div className="relative flex items-center justify-center mb-2">
                        ...
                        <motion.div
                          ...
                          style={{ border: "1.5px solid rgba(99,91,255,0.2)" }}
                        ...
                        <div
                          ...
                          style={{ background: "radial-gradient(circle, rgba(139,92,246,0.3) 0%, rgba(99,91,255,0.15) 50%, transparent 70%)" }}
                        />
                        {/* Main gradient orb */}
                        <motion.div
                          className="relative w-14 h-14 rounded-full flex items-center justify-center text-white z-10"
                          style={{
                            background: "linear-gradient(135deg, #635BFF 0%, #A855F7 50%, #EC4899 100%)",
                            boxShadow: "0 0 30px rgba(139,92,246,0.4), 0 0 60px rgba(99,91,255,0.15), inset 0 1px 1px rgba(255,255,255,0.2)",
                          }}
                      ...
                      {/* Main Greeting Heading — Animated Gradient */}
                      <motion.h1
                        ...
                        style={{
                          background: "linear-gradient(135deg, #FFFFFF 0%, #E0E7FF 35%, #A78BFA 65%, #C084FC 100%)",
                          WebkitBackgroundClip: "text",
                          WebkitTextFillColor: "transparent",
                      ...
                      <motion.p
                        ...
                        className="text-sm text-slate-400 font-medium max-w-lg leading-relaxed"
                      >
                        Skillora AI Studio — ask anything, plan projects,<br />
                        write proposals, or get code reviews.
                      </motion.p>
                    </motion.div>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className={`flex flex-col gap-2 ${isUser ? "items-end max-w-[80%]" : "items-start max-w-[88%] min-w-0 flex-1"}`}>
                            ...
                            <div
                              className={`p-4 rounded-2xl text-xs lg:text-sm leading-relaxed ${isUser
